...
Array.from || (Array.from = function() {
    ...
    return function(x) {
        ...
        var a = arguments.length > 1 ? arguments[1] : void 0, q;
        ...
        for (var A = z(this) ? Object(new this(r)) : Array(r), b = 0, c; b < r; )
            c = u[b],
            A[b] = a ? typeof q === "undefined" ? a(c, b) : a.call(q, c, b) : c,
            b += 1;
        A.length = r;
        return A
    }
...
(function(w, z) {
    ...
    function z(x, u) {
        ...
        typeof u === "string" ? (q.setRequestHeader("Content-Type", "text/plain;charset=UTF-8"),
        q.responseType = "text") : u instanceof Blob && u.type && q.setRequestHeader("Content-Type", u.type);
        try {
            q.send(u)
        } catch (r) {
            return !1
...
if (typeof responsiveVoice != "undefined")
    ...
    var ResponsiveVoice = function() {
        ...
        function z(b, c) {
            ...
            try {
                for (var h = 0; h < q.length; h++) {
                    ...
                    c.collectionvoice && c.collectionvoice.name && k.indexOf(c.collectionvoice.name) != -1 && (g = !0)) : g = !0;
                    var f = !1
                      , l = e.systemvoices;
                    l ? (Array.isArray(l) || (l = [l]),
                    c.systemvoice && c.systemvoice.name && l.indexOf(c.systemvoice.name) != -1 && (f = !0)) : f = !0;
        ...
        a.init = function() {
            a.is_wordpress = x();
            a.is_bundle = u();
            typeof rvApiKey == "undefined" && console.error("ResponsiveVoice missing API key. See https://responsivevoice.org/register?devtools=" + encodeURIComponent(window.location.href));
            if (a.is_android || a.iOS || a.is_safari)
                a.useTimer = !0;
            a.is_opera || typeof speechSynthesis === "undefined" ? (console.log("RV: Voice synthesis not supported"),
            a.enableFallbackMode()) : setTimeout(function() {
                var b = setInterval(function() {
                    var c = window.speechSynthesis.getVoices();
                    c.length != 0 || a.systemvoices != null && a.systemvoices.length != 0 ? (console.log("RV: Voice support ready"),
                    ...
                    window.speechSynthesis != null ? a.iOS ? (a.iOS11plus ? a.systemVoicesReady(a.cache_ios11_voices) : a.iOS10 ? a.systemVoicesReady(a.cache_ios10_voices) : a.iOS9 ? a.systemVoicesReady(a.cache_ios9_voices) : a.systemVoicesReady(a.cache_ios_voices),
                        ...
                        if (a.checkSpeechAllowed()) {
                            ...
                            for (e = 0; e < k.length; e++)
                                if (!a.fallbackMode && a.getServiceEnabled(a.services.NATIVE_TTS))
                                    ...
                                    d != null ? (f.voice = typeof d.voice !== "undefined" ? d.voice : g.systemvoice,
                                    e < k.length - 1 && k.length > 1 ? (f.onend = a.onPartEnd,
                                    ...
                                    f.onerror = d.onerror || function(y) {
                                        a.log("RV: Unknown Error");
                                        a.log(y);
                                        y.error === "not-allowed" && a.speechSynthesisNotAllowedError !== !0 && (a.speechSynthesisNotAllowedError = !0,
                                        a.speak(b, c, d))
                                    }
                                    ,
                                    ...
                                    f.rate = a.iOS ? (d.rate != null ? d.rate * d.rate : 1) * f.rate : (d.rate != null ? d.rate : r) * f.rate,
                                    f.volume = d.volume != null ? d.volume : f.volume) : (a.log("No Params received for current Utterance"),
                                    ...
                                    var G = "?t=" + encodeURIComponent(k[e]) + "&tl=" + (g.collectionvoice.lang || g.systemvoice.lang || "en-US") + "&sv=" + (g.collectionvoice.service || g.systemvoice.service || "") + "&vn=" + (g.collectionvoice.voicename || g.systemvoice.voicename || "") + "&pitch=" + f.toString() + "&rate=" + l.toString() + "&vol=" + t.toString();
        ...
        a.startTimeout = function(b, c) {
            ...
            d <= 0 || (a.timeoutId = setTimeout(c, a.getEstimatedTimeLength(b, d)),
        ...
        a.speech_onend = function() {
            ...
            a.cancelled === !0 ? a.cancelled = !1 : (a.log("on end fired"),
            a.msgparameters != null && a.msgparameters.onend != null && a.msgparameters.onendcalled != 1 && (a.log("Speech on end called  -" + a.msgtext),
        ...
        a.fallback_finishPart = function(b) {
            ...
            a.timeoutId = setTimeout(a.fallback_finishPart, (a.fallback_audio.duration - a.fallback_audio.currentTime) * 1E3)) : (a.checkAndCancelTimeout(),
        ...
        a.cancel = function() {
            a.checkAndCancelTimeout();
            a.fallbackMode ? (a.fallback_audio != null && a.fallback_audio.pause(),
        ...
        a.setDefaultRate = function(b) {
            var c = b;
            b = parseFloat(b);
            isNaN(b) ? console.error("[responsiveVoice.setDefaultRate] invalid argument: " + c.toString()) : b === 0 ? console.error("[responsiveVoice.setDefaultRate] rate must be > 0") : b > 1.5 ? console.error("[responsiveVoice.setDefaultRate] rate must be <= 1.5") : r = b
        }
        ;
        a.mapRVs = function() {
            if ("object" == typeof navigator) {
                var b, c = "anguage", d = navigator;
                var h = (b = d["l" + c + "s"],
            ...
            for (b = 0; b < a.responsivevoices.length; b++)
                for (c = a.responsivevoices[b],
                d = 0; d < c.voiceIDs.length; d++) {
        ...
        a.getResponsiveVoice = function(b) {
            for (var c = 0; c < a.responsivevoices.length; c++)
                if (a.responsivevoices[c].name == b)
                    ...
                    a.fallbackMode = a.responsivevoices[c].mappedProfile.collectionvoice.fallbackvoice === !0 || a.forcedFallbackMode === !0 ? !0 : !1,
        ...
        a.initializePermissions = function() {
            ...
            typeof speechSynthesis !== "undefined" && (b = new SpeechSynthesisUtterance(" "),
            speechSynthesis.speak(b)),
        ...
        a.initFallbackPool = function() {
            if (!a.fallback_audiopool || a.fallback_audiopool.length == 0) {
                for (var b = 0; b < 10; b++) {
                    ...
                    d.load(),
                    c == 9 && (a.log("Android HTML audio initialized"),
                    a.android_initialized = !0));
                    ...
                    d.load(),
                    c == 9 && (a.log("iOS HTML audio initialized"),
                    a.iOS_initialized = !0));
        ...
        ;
        a.pause = function() {
            a.fallbackMode ? a.fallback_audio != null && a.fallback_audio.pause() : (speechSynthesis.pause(),
                ...
                return function(p, m) {
                    ...
                    if (Symbol.iterator in Object(p)) {
                        var v = []
                          ...
                          , H = void 0;
                        try {
                            for (var C = p[Symbol.iterator](), E; !(n = (E = C.next()).done) && (v.push(E.value),
                            !m || v.length !== m); n = !0)
                                ;
                        } catch (I) {
                            B = !0,
        ...
        a.getWords = function(b) {
            ...
            for (var d = 0; d < c.length; d++)
                (b = c[d].toString().match(/\d+/)) != null && (c.splice(d, 1),
        ...
        document.readyState === "interactive" ? a.init() : document.addEventListener("DOMContentLoaded", function() {
            a.init()
        });
