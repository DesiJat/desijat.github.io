...
const RADIUS = 20; // Increased radius to cover more area

const siteLink = {
    "light": "https://c.tile.openstreetmap.org/{z}/{x}/{y}.png",
    "dark": "https://b.basemaps.cartocdn.com/dark_all/{z}/{x}/{y}@2x.png"
}
const TILE_URL = siteLink[mapType];
