...
// const SQL_WASM_PATH = "https://desijat.github.io/sqlite-viewer/js/sql-wasm.wasm";
const SQL_WASM_PATH = window.location.origin + window.location.pathname + "js/sql-wasm.wasm";
document.getElementById("home-page").href = window.location.origin + window.location.pathname;

document.getElementById("sample-db-link-db").href = "?url=" + encodeURIComponent(
    new URL("examples/books.db", window.location.href).href
);
document.getElementById("sample-db-link-sqlite").href = "?url=" + encodeURIComponent(
    new URL("examples/Album.sqlite", window.location.href).href
);
